...
(function() {
  var async, req, _config, _getCreateNode, _getCreateRelation, _q;
  ...
  exports.createBatch = function(nodeOpts, nodes, relOpts, rels, done) {
    var data, i, n, r;

    n = r = [];
    if (nodes) {
      n = nodes.map(function(m) {
        var q;
